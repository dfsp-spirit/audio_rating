...
#
# To use this script, simply run it from the terminal. It will coyp cfg files and start nginx in the background and then run the FastAPI backend in the foreground.
#
